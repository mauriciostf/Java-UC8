...
public class FrmCombo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Operação com ComboBox");

        lblCidade.setText("Cidade:");

        cbCidade.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Canela", "Sapucaia do Sul", "Portão", "Porto Alegre", "Ivoti", "Novo Hamburgo", "Canoas", "Esteio", "Gramado", "Estancia Velha", "Sao leopoldo" }));
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
       String cidade = cbCidade.getSelectedItem().toString();
        JOptionPane.showMessageDialog(null, "A cidade selecionada é: " + cidade);
